...
interface SettlementSummaryRightProps {
...
export function SettlementSummaryRight({ details = [], columnDisplay }: SettlementSummaryRightProps) {
  const { displayRemaining, isCopay, isDeduct } = columnDisplay ?? {};

  return (
    <tr style={{ height: '50px' }} className="bg-gray-100 font-semibold text-sm">
      {/* Benefit */}
      <td className="border-t border-gray-300 bg-gray-100 px-3 py-2" style={{ minWidth: '130px' }}>
        -
      </td>
